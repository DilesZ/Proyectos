...
| **Video Short** | Reels / Shorts | Viralidad | Movimiento natural (Wan 2.1), 5-10 segundos, audio en tendencia. |
...
### C. Consistencia mediante LoRA + ControlNet
Para asegurar que tu influencer siempre sea la misma:
- **LoRA**: Fija la identidad facial.
- **ControlNet (Canny/OpenPose)**: Permite que si ves un vídeo viral de una chica real bailando, puedas "calcar" su movimiento y ponérselo a tu influencer de IA manteniendo su cara.
